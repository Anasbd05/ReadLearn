...
export const metadata: Metadata = {
  title:
    "Learn French Through Reading | Build Vocabulary Naturally - FluencyWave",
  description:
    "Master French faster through reading. Click any word for instant translation, build vocabulary naturally, and read books, articles, and stories at your level. Start learning French today!",
  keywords:
    "learn French, French vocabulary, learn French through reading, improve French reading, French language learning, build French vocabulary, French fluency, apprendre le français",
  openGraph: {
    title: "Learn French Through Reading | FluencyWave",
    description:
      "The fastest way to French fluency through natural reading and vocabulary building.",
    type: "website",
  },
};

export default function LearnFrench() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Learn <span className="text-primary">French</span> Through Reading
          </h1>
          <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            The fastest path to French fluency isn&apos;t through grammar
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-8">
            Why Reading is the Fastest Way to Learn French
          </h2>
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            <p className="text-lg leading-relaxed">
              You&apos;ve probably spent years studying French grammar,
            ...
            <p className="text-lg leading-relaxed">
              When you read in French, you&apos;re not just learning isolated
              words or abstract rules. You&apos;re seeing how native speakers
              actually use the language. You&apos;re absorbing sentence
              patterns, natural expressions, and the rhythm of French—all
            ...
            <p className="text-lg leading-relaxed">
              ...
              French, but faster. Every sentence you read is a real example of
              how French works in the wild.
            </p>
            <p className="text-lg leading-relaxed">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            <p className="text-lg leading-relaxed">
              Here&apos;s something most French courses won&apos;t tell you:{" "}
            ...
            <p className="text-lg leading-relaxed">
              ...
              French. But if you don&apos;t know the words, you can&apos;t say
              anything at all. A strong vocabulary lets you express complex
              ideas, understand French movies and books, and have real
              conversations—even if your grammar isn&apos;t perfect.
            </p>
            <p className="text-lg leading-relaxed">
              Native French speakers understand &ldquo;Hier je aller au
              magasin&rdquo; even though the grammar is wrong. But perfect
            ...
            <p className="text-lg leading-relaxed">
              ...
              French words you know, the better you understand, and the better
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-8">
            How Reading Expands Your French Vocabulary
          </h2>
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            <p className="text-lg leading-relaxed">
              Reading is the ultimate vocabulary builder because you encounter
              French words in their natural habitat. You don&apos;t just see a
              word and its definition—you see it being used in a real sentence,
              with real context and meaning.
            </p>
            <p className="text-lg leading-relaxed">
              When you read &ldquo;Elle se sentait <em>mélancolique</em> en
              regardant le coucher du soleil,&rdquo; you understand mélancolique
              means a sad, reflective feeling—not just &ldquo;tristesse&rdquo;
              from a dictionary. You learn the nuance, the emotion, the
              situations where French speakers use that word. That&apos;s
            ...
            <p className="text-lg leading-relaxed">
              ...
              &ldquo;omniprésent&rdquo; five times in different articles,
              you&apos;ll never forget it means &ldquo;everywhere.&rdquo;
            </p>
            <p className="text-lg leading-relaxed">
              Plus, reading exposes you to thousands of French words—far more
              than any vocabulary list or flashcard deck ever could. A single
              French novel contains 10,000+ unique words. That&apos;s more
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-8">
            Read French Without the Struggle
          </h2>
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            <p className="text-lg leading-relaxed">
              The problem with reading in French? You constantly run into words
              you don&apos;t know. You either skip them (and miss the meaning)
              or stop to look them up (and lose your flow). Both options are
              frustrating.
            </p>
            <p className="text-lg leading-relaxed">
              That&apos;s why we built FluencyWave. Click any French word or
            ...
            <p className="text-lg leading-relaxed">
              Want to read about something specific? Our AI can generate French
